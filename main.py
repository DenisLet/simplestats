...
from models import Base, SoccerMain, Bet365Odds, XbetOdds, SoccerHalf1Stats, SoccerHalf2Stats, SoccerTimeLine, HockeyMain, XbetOddsHoc
...
def calculate_goals_statistics(matches, selected_bookmaker):
    ...
    for match in matches:
        ...
        # Добавляем подсчет фор +2.5 и -2.5
        if home_goals - away_goals > 2.5:
            stats["win_with_handicap_2_5"] += 1  # Фора +2.5
        if home_goals - away_goals > -2.5:
            stats["win_with_handicap__2_5"] += 1  # Фора -2.5
